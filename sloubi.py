...
while pm >= 1:
    ...
    try:
        ...
        if int(pm) < int(tune) or int(tune) < 1:
            ...
            rep = "caca"
            time.sleep(1.5)
            humeuradv = {0: "avec tellement d'intensité que ses veines oculaires sont plus grosses que son globe.",
                         1: "avec un regard biaiseux.",
                         2: "en explosant de rire, tout en vous postillonnant dessus.",
            }
            if dj > dadv:
                test = 0
            elif dj == dadv:
                ...
                test = 2
            print(adv + " a sorti un %s," %(dadv) + " et vous regarde " + humeuradv[test])
            time.sleep(1.5)
                    ...
                    if rep == "a":
                        ...
                        while papa != "a" and papa != "b" and papa != "c" and papa != "d" and papa != "e" and papa != "f":
                            ...
                            if papa == "a":
                                ...
                                #On divise tous les jets de dés par 6
                                ...
                                while sloubi < dj:
                                    ...
                                    print("STOP ?")
                                    time.sleep(1)
                                    print("Non, là il faut dire 'Sloubi'............ Voilà !")
                                    time.sleep(1)
                            else:
